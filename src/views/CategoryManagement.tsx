  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white dark:bg-zinc-900 rounded-3xl border border-zinc-200 dark:border-zinc-800 shadow-sm overflow-hidden">
        <TableActionBar onFilter={() => setShowFilters((prev) => !prev)} filterActive={showFilters} printTargetId="category-table-data" />
        {showFilters && (
        ...
        <div id="category-table-data" className="overflow-x-auto">
